...
namespace SQLTableExport
{
    public partial class Form1 : Form
    {
        ...
        {
            string queryString = "DELETE FROM TableSchema1";
        ...
        {
            this.richTextBox1.AppendText("+++ UpdateCommand: " + row[0].ToString() + ", " + row[2].ToString() + ", " + row[5].ToString() + "." + System.Environment.NewLine);
            this.richTextBox1.SelectionStart = this.richTextBox1.TextLength;
            this.richTextBox1.ScrollToCaret();

            string queryString = "UPDATE TableSchema SET _DF=@_DF,_DF_Value=@_DF_Value WHERE TableName=@TableName and FieldName=@FieldName";
            ...
            using (SqlCommand command = new SqlCommand(queryString, connection))
                {
                    try
                    {
                        ...
                        command.Parameters.Add("@_DF", SqlDbType.Char).Value = "4";
                        command.Parameters.Add("@_DF_Value", SqlDbType.Char).Value = "369456";
        ...
        {
            this.richTextBox1.AppendText("+ InsertCommand: " + row[0].ToString() + ", " + row[2].ToString() + ", " + row[5].ToString() + "." + System.Environment.NewLine);
            this.richTextBox1.SelectionStart = this.richTextBox1.TextLength;
            this.richTextBox1.ScrollToCaret();

            string queryString = "INSERT INTO TableSchema(SeqNo,TableName,FieldName,_Type,_Len,_PK,_Null,_DF,_DF_Value,_DESC,updDate)" +
                    " VALUES(@SeqNo,@TableName,@FieldName,@_Type,@_Len,@_PK,@_Null,@_DF,@_DF_Value,@_DESC,@updDate)";
            ...
            using (SqlCommand command = new SqlCommand(queryString, connection))
            {
                try
                {
                    ...
                    command.Parameters.Add("@_DF", SqlDbType.Char).Value = "0";
                    command.Parameters.Add("@_DF_Value", SqlDbType.Char).Value = "0";
                    command.Parameters.Add("@_DESC", SqlDbType.VarChar).Value = "0";
